...
public class VehicleAVFX : MonoBehaviour
{
	...
	public ParticleSystem engineThrusterL1;	//The left thruster particles
	public ParticleSystem engineThrusterR1;	//The right thruster particles
	...
	void Reset()
	{
		...
		engineThrusterL1 = GameObject.Find("Ship Body/Ship VFX/ThrusterPS-L1").GetComponent<ParticleSystem>();
		engineThrusterR1 = GameObject.Find("Ship Body/Ship VFX/ThrusterPS-R1").GetComponent<ParticleSystem>();
	...
	void UpdateThrusterParticles()
	{
		...
		if (currentLifeTime > 0f)
		{
			...
			engineThrusterR1.Play();
			engineThrusterL1.Play();
			...
			//...update the particle life for the left thruster...
			mainModule = engineThrusterL1.main;
			mainModule.startLifetime = currentLifeTime;
			//...and then update the particle life for the right thruster
			mainModule = engineThrusterR1.main;
			mainModule.startLifetime = currentLifeTime;
		}
		...
		else
		{
			...
			engineThrusterR1.Stop();
			engineThrusterL1.Stop();
		}
	}
